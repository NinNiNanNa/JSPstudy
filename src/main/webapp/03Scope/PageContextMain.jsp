...
*/
pageContext.setAttribute("pageInteger", 1000);						// 정수형(Integer) 데이터
pageContext.setAttribute("pageString", "페이지 영역의 문자열");		// 문자열(String) 데이터
pageContext.setAttribute("pagePerson", new Person("한석봉", 99));	// 일반적인 클래스를 통해 생성한 인스턴스
/*
	위에서는 3가지 형태의 데이터를 page영역에 저장한다.
	저장시에는 setAttribute(속성명, 속성값) 메서드를 사용한다.
	영역은 Object를 기반으로 모든 데이터를 저장할 수 있다.
*/
%>
<!DOCTYPE html>
<html>
...
<body>
	...
	/*
		...
		Object형으로 자동형변환되어 저장되므로 값을 읽을때는 원래의 형으로 다운캐스팅(강제형변환) 후 사용해야한다.
	*/
	%>
	<ul>
