...
//아래와 같이 타입매개변수를 생략해도 Object기반의 컬렉션이다.
...
//EL은 영역에 저장된 값을 대상으로 page영역에 속성을 저장한다.
...
<ul>
   ...
   <!-- EL식 앞에 \(역슬러쉬)를 붙이면 주석이된다. 단, 코드가
   숨겨지는 것은 아니고 코드가 그대로 화면에 출려된다. -->
</ul>
</body>
</html>